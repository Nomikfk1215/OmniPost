...
<!-- TECH STACK BADGES -->
<p>
  <img src="https://img.shields.io/badge/Next.js-14-000000?style=for-the-badge&logo=nextdotjs&logoColor=white&labelColor=0f172a" />
  <img src="https://img.shields.io/badge/React-18-61DAFB?style=for-the-badge&logo=react&logoColor=white&labelColor=0f172a" />
  <img src="https://img.shields.io/badge/TypeScript-5-3178C6?style=for-the-badge&logo=typescript&logoColor=white&labelColor=0f172a" />
  <img src="https://img.shields.io/badge/Tailwind-3-06B6D4?style=for-the-badge&logo=tailwindcss&logoColor=white&labelColor=0f172a" />
  <img src="https://img.shields.io/badge/Zod-3E67B1?style=for-the-badge&logo=zod&logoColor=white&labelColor=0f172a" />
  <img src="https://img.shields.io/badge/Drizzle-ORM-C5F74F?style=for-the-badge&logo=drizzle&logoColor=black&labelColor=0f172a" />
</p>

<p>
  <img src="https://img.shields.io/badge/⚡_LLM-OpenAI_Compatible-10b981?style=flat-square&labelColor=0f172a" />
  <img src="https://img.shields.io/badge/🎯_4_Platforms-WeChat_|_Zhihu_|_XHS_|_Bilibili-6366f1?style=flat-square&labelColor=0f172a" />
  <img src="https://img.shields.io/badge/🔒_Keys-AES--256--GCM-f59e0b?style=flat-square&labelColor=0f172a" />
  <img src="https://img.shields.io/badge/license-MIT-94a3b8?style=flat-square&labelColor=0f172a" />
</p>
...
```mermaid
graph TB
    Browser["🖥️ Browser / 用户界面"]
    
    subgraph Next["Next.js 14 App Router"]
        API["API Routes<br/>Zod 校验"]
    end
    
    subgraph Pipeline["LLM Pipeline"]
        LLM["两阶段生成<br/>2-Phase Gen"]
        Prompt["Prompt 组装<br/>Skills + Presets"]
        Valid["校验器<br/>Per-Platform"]
    end
    
    subgraph Data["Data Layer"]
        Store["JSON Store<br/>本地文件"]
        Skills["Skill 定义<br/>JSON Config"]
        Presets["风格预设<br/>Professional / Casual"]
        Settings["LLM 设置<br/>AES Encrypted"]
    end
    
    Output["📦 Platform Contents<br/>mock URL"]
